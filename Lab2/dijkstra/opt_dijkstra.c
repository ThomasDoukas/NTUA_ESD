...
//Original List Declaration
//QITEM *qHead = NULL;

// qHead represents the List
#if defined(SLL)
cdsl_sll *qHead;
#elif defined(DLL)
cdsl_dll *qHead;
...
void enqueue (int iNode, int iDist, int iPrev)
{
  ...
  //Library method "enqueue" replaces manual enqueue of qNew
  ...
  if (qHead)
    {
      ...
      *piPrev = qKill->iPrev;
      ...
      //Library method "remove" replaces manual dequeue of qHead
