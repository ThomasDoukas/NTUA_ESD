...
extern size_t _strlen(const char * str_src);
extern char* _strcpy(char * str_dst, const char * str_src);
extern char* _strcat(char * str_dst, const char * str_src);
extern int _strcmp(const char * str_1, const char * str_2);
